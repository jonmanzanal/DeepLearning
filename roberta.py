...
def predict(predictions,actual=actual):
    ...
    print('roberta-large-mnli Accuracy',accuracy_score(actual, predicted))
    print('roberta-large-mnli F1 Macro',f1_score(actual, predicted,average='macro'))
