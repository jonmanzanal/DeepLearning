...
def predict(predictions,actual=actual):
    ...
    print('finiteautomata/bertweet-base-sentiment-analysis Accuracy',accuracy_score(actual, predicted))
    print('finiteautomata/bertweet-base-sentiment-analysis F1 Macro',f1_score(actual, predicted,average='macro'))
